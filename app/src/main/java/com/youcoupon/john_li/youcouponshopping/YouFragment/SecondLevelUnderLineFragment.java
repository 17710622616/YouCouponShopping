...
public class SecondLevelUnderLineFragment extends LazyLoadFragment {
    ...
    private void initData() {
        ...
        mSmartOrderRefreshAdapter = new SmartOrderRefreshAdapter(getActivity(), orderList,2);
    ...
    private void callNetGetCarList() {
        RequestParams params = new RequestParams(YouConfigor.BASE_URL + YouConfigor.GET_SECONDE_LEVEL_ORDER_LIST);
