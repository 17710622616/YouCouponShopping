        ...
        x.http().request(HttpMethod.POST ,params, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                if (model.getStatus() == 0) {
                    Toast.makeText(ForgetPwdActivity.this, "修改密码成功" + String.valueOf(model.getMessage()), Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(ForgetPwdActivity.this, "修改密码失败" + String.valueOf(model.getMessage()), Toast.LENGTH_SHORT).show();
                }
            }
            //请求异常后的回调方法
            @Override
            public void onError(Throwable ex, boolean isOnCallback) {
                if (ex instanceof java.net.SocketTimeoutException) {
                    Toast.makeText(ForgetPwdActivity.this, R.string.callnet_timeout, Toast.LENGTH_SHORT).show();
                } else {
